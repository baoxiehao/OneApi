defmodule OneApi.Rss.GeekPark do
  use HTTPoison.Base
  ...
  def process_response_body(html) do
    ...
    |> Enum.map(&OneApi.Rss.GeekPark.parse/1)
  end
  ...
  <article class="article-item">
    <a class="dib-top img-cover-wrap" data-event-action="view" data-event-category="home.article-list.cover" data-event-label="被红包充斥的除夕夜过去了，这里是关于红包你需要知道的所有玩法和数据 /topics/217806" href="/topics/217806" target="_blank">
      <div class="responsive-img">
        <img alt="被红包充斥的除夕夜过去了，这里是关于红包你需要知道的所有玩法和数据" class="img-cover js-lazy" data-ratio="0.618" data-src="https://ocpk3ohd2.qnssl.com/uploads/image/file/e4/57/e457f96d87d6933bcae763d43606c1c3.jpeg" data-vw="22" /></div>
    </a>
    <div class="dib-top article-info">
      <div class="article-info-wrapper">
        <a class="category-tag" data-event-action="view" data-event-category="home.article-list.category-link" data-event-label="今日看点" href="/collections/%E4%BB%8A%E6%97%A5%E7%9C%8B%E7%82%B9" style="background-color: #BF6505;" target="_blank">今日看点</a>
        <a class="article-title" data-event-action="view" data-event-category="home.article-list.title" data-event-label="被红包充斥的除夕夜过去了，这里是关于红包你需要知道的所有玩法和数据" href="/topics/217806" target="_blank">被红包充斥的除夕夜过去了，这里是关于红包你需要知道的所有玩法和数据</a>
        <p class="article-description">朋友，抢了多少红包了？</p>
        <div class="article-source">
          <div class="source-left">
            <span class="author-divide">|</span>
            <a class="dib-middle article-author" data-event-action="view" data-event-category="home.article-list.author" data-event-label="张雨忻" href="/users/412656" target="_blank">张雨忻</a>
            <span class="dib-middle article-publish">
              <i class="iconfont icon-time dib-middle"></i>
              <a class="article-time js-relative-time dib-middle" data-time="1485571920" href="javascript:;" title="2017-01-28 10:52:00"></a>
            </span>
          </div>
  ...
  def fetch do
    OneApi.Rss.GeekPark.start
    case OneApi.Rss.GeekPark.get("/") do
      {:ok, response} ->
        {:ok, response.body}
      {:error, reason} ->
        {:error, "Error #{reason}"}
